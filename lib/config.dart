class Config {
  // API Configuration
  static const String apiUrl = 'https://luntiang-kamay.onrender.com';
  ...
  static const String smtpUsername =
      'charmaine.l.d.cator@gmail.com'; // SMTP username
  ...
  static const String smtpFromEmail =
      'charmaine.l.d.cator@gmail.com'; // Email used as "From"
}
